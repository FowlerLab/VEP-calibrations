...
##read in relevant files for gene specifc dataframes with the correct directories, files should be in 'Fig4_S2_plots', total of 7 files to read in 
...
csf1r_fig = REVEL_hist(csf1r_clinvar, csf1r_revel, 12, 'CSF1R')

msh2_revel_fig = REVEL_hist(msh2_clinvar, msh2_revel, 50, 'MSH2')

eng_revel_fig = REVEL_hist(eng_clinvar, eng_revel, 12, 'ENG')
...
col7a1_fig = BayesDel_hist(col7a1_clinvar,col7a1_bayes,40,'COL7A1')

msh2_bayes_fig = BayesDel_hist(msh2_clinvar,msh2_bayes,50,'MSH2')

eng_bayes_fig = BayesDel_hist(eng_clinvar,eng_bayes,16,'ENG')
