...
##this script creates the whole genome plots in Figure 1 for REVEL and BayesDel. REVEL and BayesDel all snv files are big and it's not recommended to run this script locally

##read in all snv revel file, all snv bayesdel file and supplementary table 1 (ClinGen SVI calibration dataset)
